...
INCLUDE = -ISrc/BSP/Components/ampire480272 \
          ...
          -I./Src/analyzer/lcd \
          -I./Src/analyzer/osl \
          -I./Src/analyzer/pomiar \
          -I./Src/analyzer/metody \
...
SRC :=   Src/analyzer/config/config.c \
        Src/analyzer/config/format_konfiguracji.c \
        Src/analyzer/config/jezyk.c \
        Src/analyzer/config/uzytkownik.c \
        Src/analyzer/config/tryb_interfejsu.c \
        Src/analyzer/dsp/dsp.c \
        Src/analyzer/dsp/sprawdzenie_if.c \
        Src/analyzer/dsp/port_extension.c \
        ...
        Src/analyzer/lcd/splash.c \
        Src/analyzer/lcd/splashfont.c \
        Src/analyzer/lcd/smith.c \
        Src/analyzer/lcd/textbox.c \
        Src/analyzer/lcd/ui_lista_logika.c \
        Src/analyzer/lcd/ui_wspolny.c \
        Src/analyzer/lcd/ui_edytor_liczby.c \
	Src/analyzer/lcd/bitmaps/ikony_motywow.c \
	Src/analyzer/lcd/bitmaps/ikony_szczegolowe_makiety.c \
	Src/analyzer/lcd/bitmaps/ikony_szczegolowe_nowe.c \
        Src/analyzer/lcd/touch.c \
        Src/analyzer/lcd/menufont.c \
        Src/analyzer/lcd/kafelfont.c \
        Src/analyzer/lcd/bdigits.c \
        Src/analyzer/osl/match.c \
        Src/analyzer/osl/kalibracja_meta.c \
        Src/analyzer/osl/oslfile.c \
        Src/analyzer/osl/osl70cm.c \
        Src/analyzer/pomiar/rf_akwizycja.c \
        Src/analyzer/pomiar/rf_korekcja.c \
        Src/analyzer/pomiar/pomiar_s11.c \
        Src/analyzer/metody/rejestr_metod.c \
        Src/analyzer/metody/q_porownanie.c \
        Src/analyzer/metody/q_okrag.c \
        Src/analyzer/metody/element_rf.c \
        Src/analyzer/metody/dopasowanie_l.c \
        Src/analyzer/metody/kabel_linia.c \
        Src/analyzer/metody/profil_kabla.c \
        Src/analyzer/metody/diagnostyka_wzorcow_osl.c \
        Src/analyzer/metody/strojenie_antena.c \
        Src/analyzer/metody/baza_anten.c \
        Src/analyzer/metody/tdr_interpretacja.c \
        Src/analyzer/metody/synteza_cauer_foster.c \
        Src/analyzer/metody/dopasowanie_cauer_foster.c \
        Src/analyzer/metody/porownanie_modeli_elementu.c \
        Src/analyzer/metody/s21_analiza.c \
        ...
        Src/analyzer/window/diagnostyka.c \
        Src/analyzer/window/zworka_cal.c \
        Src/analyzer/window/audiodsp.c \
        Src/analyzer/window/centrum_kalibracji.c \
        Src/analyzer/window/menedzer_plikow.c \
        Src/analyzer/window/zgloszenie_bledu.c \
        Src/analyzer/window/generator.c \
        Src/analyzer/window/keyboard.c \
        Src/analyzer/window/komunikaty.c \
        Src/analyzer/window/kwarc_metrologia.c \
        Src/analyzer/window/kwarc_seria.c \
        Src/analyzer/window/lc_metrologia.c \
        Src/analyzer/window/metody_eksperymentalne.c \
        Src/analyzer/window/mainwnd.c \
        Src/analyzer/window/dokumentacja_przyklady.c \
        Src/analyzer/window/dokumentacja_realna.c \
        Src/analyzer/window/projektowanie_anten.c \
        Src/analyzer/window/analiza_przebiegu.c \
        ...
        Src/analyzer/window/profil_uzytkownika.c \
        Src/analyzer/window/screenshot.c \
        Src/analyzer/window/tdr.c \
        Src/analyzer/window/lacznosc.c \
        Src/analyzer/window/tdr_metrologia.c \
        Src/analyzer/window/recandplay.c \
        ...
        Src/analyzer/rtc/STM32F7RTC.c \
        Src/analyzer/gpio/gpio_control.c \
        Src/analyzer/gpio/wejscia_uzytkownika.c \
        Src/analyzer/BeepTimer.c \
