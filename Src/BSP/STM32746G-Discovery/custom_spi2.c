...
#define SPIx_SLAVE0_PIN                  GPIO_PIN_14
#define SPIx_SLAVE0_GPIO_PORT            GPIOB
#define SPIx_SLAVE0_GPIO_CLK_ENABLE()    __HAL_RCC_GPIOB_CLK_ENABLE()
...
void SPI2_Init(void)
{
    ...
    /* ADF4350/ADF4351 zatrzaskuja dane na zboczu narastajacym CLK.
     * CPOL=LOW + CPHA=1EDGE daje tryb SPI 0 i jednoznaczny stan spoczynkowy. */
