...
#define TEXTBOX_WYNIK_NAWIGACJA 3U
#define TEXTBOX_TEKST(id) ((uint16_t)(id) + 1U)
...
typedef enum
{
    TEXTBOX_ROLA_ZWYKLA = 0,
    TEXTBOX_ROLA_WSTECZ,
    TEXTBOX_ROLA_START_STOP,
} TEXTBOX_ROLA_t;
...
typedef struct
{
    ...
    uint8_t rola;        //TEXTBOX_ROLA_t; pozwala przypisac fizyczne przyciski niezaleznie od jezyka
    uint16_t tekst_id;   //0 = pole .text; pozostale wartosci to TEKST_ID_t + 1
