...
#define LCD_RGB(r, g, b) ((LCDColor)(0xFF000000ul |                     \
    ...
    /*
     * Prosty podwójny bufor dla ekranów, które okresowo przerysowują większą
     * część zawartości. Kod rysuje pełną nową klatkę na warstwie ukrytej,
     * a dopiero po zakończeniu przełącza ją podczas przeładowania LTDC.
     * Dzięki temu użytkownik nie widzi ekranu w połowie rysowania.
     */
    typedef struct
    {
        uint8_t warstwa_widoczna;
        uint8_t gotowy;
    } LCD_BUFOR_KLATKI_t;
