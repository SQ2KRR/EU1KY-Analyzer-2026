...
{
         /*
          * RTC ma staly 7-bitowy adres 0x68 (D0h w starej, 8-bitowej
          * notacji programu). Test ACK jest pewniejszy od odczytywania sekund
          * i czekania, czy licznik zdazy sie zmienic.
          */
         return CAMERA_IO_IsDeviceReady(DS3231_Write_addr);
}
