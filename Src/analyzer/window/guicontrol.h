...
#define BTN_DIAGNOSTYKA 9 //DIAGNOSTYKA / TESTY SERWISOWE
...
const int buttonsArea[BUTTON_COUNT][4] = {
    {COL1_LEFT, LINE1_TOP, COL1_RIGHT, LINE1_BOTTOM},
    {COL2_LEFT, LINE1_TOP, COL2_RIGHT, LINE1_BOTTOM},
    {COL3_LEFT, LINE1_TOP, COL3_RIGHT, LINE1_BOTTOM},
    {COL4_LEFT, LINE1_TOP, COL4_RIGHT, LINE1_BOTTOM},
    {COL5_LEFT, LINE1_TOP, COL5_RIGHT, LINE1_BOTTOM},
    {COL1_LEFT, LINE2_TOP, COL1_RIGHT, LINE2_BOTTOM},
    {COL2_LEFT, LINE2_TOP, COL2_RIGHT, LINE2_BOTTOM},
    {COL3_LEFT, LINE2_TOP, COL3_RIGHT, LINE2_BOTTOM},
    {COL4_LEFT, LINE2_TOP, COL4_RIGHT, LINE2_BOTTOM},
    {COL5_LEFT, LINE2_TOP, COL5_RIGHT, LINE2_BOTTOM},
    {COL1_LEFT, LINE3_TOP, COL1_RIGHT, LINE3_BOTTOM},
    {COL2_LEFT, LINE3_TOP, COL2_RIGHT, LINE3_BOTTOM},
    {COL3_LEFT, LINE3_TOP, COL3_RIGHT, LINE3_BOTTOM},
    {COL4_LEFT, LINE3_TOP, COL4_RIGHT, LINE3_BOTTOM},
    {COL5_LEFT, LINE3_TOP, COL5_RIGHT, LINE3_BOTTOM},
};
